...
export class ChatGPTApi implements LLMApi {
  public ChatPath = "/api/chatgpt/v1/chat/completions";
  public UsagePath = "/api/chatgpt/dashboard/billing/usage";
  public SubsPath = "/api/chatgpt/dashboard/billing/subscription";
