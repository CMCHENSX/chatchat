...
export function Chat() {
	...
	const doSubmit = (userInput: string) => {
		...
		setIsLoading(true);
		chatStore.onUserInput(userInput, websiteConfigStore, authStore)
		...
		showModal({
			...
			children: (
				...
				<Input
					...
					onChange={(e) => (newTopic = e.currentTarget.value)}
				/>
				// </div>
			),
			actions: [
		...
		<div className={styles.chat} key={session.id}>
			<div className="window-header">
				<div className="window-header-title">
					...
					{!isMobileScreen && <div className="window-header-sub-title">
						{chatPageSubTitle
			...
			>
				{messages.map((message, i) => {
					...
					isprompt = !isUser && message.streaming === true;
					...
					return (
						<>
							...
							{shouldShowClearContextDivider && <ClearContextDivider key={message.id ?? i} />}
						</>
					);
				})}
			</div>
