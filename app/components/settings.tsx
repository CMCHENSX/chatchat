...
export function Settings() {
  ...
  const currentVersion = "1.0.1"; //formatVersionDate(updateStore.version);
    ...
    <ErrorBoundary>
      <div className="window-header">
        ...
        <div className="window-actions">
          <Popconfirm
            title={Locale.Settings.Actions.ConfirmClearAll}
            // description={Locale.Settings.Actions.ConfirmClearAll}
            onConfirm={() => {
          ...
          <Popconfirm
            title={Locale.Settings.Actions.ConfirmResetAll}
            // description={Locale.Settings.Actions.ConfirmResetAll}
            onConfirm={() => {
              resetConfig();
            }}
            okText={Locale.UI.Confirm}
        ...
        <List>
          ...
          <ListItem title={Locale.Settings.SendKey}>
            <Select
              ...
              style={{ width: 150 }}
              onChange={(e) => {
                updateConfig((config) => (config.submitKey = e));
              }}
          ...
          {/*<ListItem title={Locale.Settings.Lang.Name}>
            <Select value={getLang()} style={{ width: 150 }}
              onChange={(e) => {
                changeLang(e as any);
              }}
