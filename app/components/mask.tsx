...
export function MaskConfig(props: {
  ...
  const [showPicker, setShowPicker] = useState(false);
	// default is true
	// props.mask.syncGlobalConfig = props.shouldSyncFromGlobal === false ? false : true;
...
function ContextPromptItem(props: {
  ...
  return (
    <div className={chatStyle["context-prompt-row"]}>
      ...
      {!focusingInput && (
        <Popconfirm
          title={Locale.Mask.Item.DeleteConfirm}
          onConfirm={() => {
            props.remove();
          }}
  ...
  const langs = [
    {
      ...
      label: Locale.Settings.Lang.All,
      className: "ant-select-lang-item",
    },
    ...AllLangs.map((lang) => ({
      value: lang,
