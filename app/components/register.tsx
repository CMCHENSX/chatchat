...
export function Register() {
  ...
  // const registerPageSubTitle = "注册即可免费使用";
  ...
  function getRegisterCaptcha() {
    ...
    fetch("/api/user/get_pic_code", {
      ...
      if (result.code != 200) {
        ...
        setCaptcha("data:image/jpg;base64," + result.data.picCodeBase64);
        setCaptchaId(result.data.picCodeSessionId);
      }
    });
  }
  useEffect(() => {
      ...
      <div className="window-header">
        <div className="window-header-title">
          ...
          <div className="window-header-sub-title">
            {registerPageSubTitle || Locale.RegisterPage.SubTitle}
          </div>
        </div>
